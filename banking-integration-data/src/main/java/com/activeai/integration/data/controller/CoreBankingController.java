...
public class CoreBankingController {
  ...
  @GetMapping(value = "/reset/{customerId}/creditcards")
  ...
  @GetMapping(value = "/reset/{customerId}/cards/transactions")
  ...
  @GetMapping(value = "/reset/{customerId}/accounts/transactions")
  ...
  @PostMapping(value = "/init/{customerId}/payee", consumes = {"application/json"}) public ResponseEntity<String> resetPayeeResponse(
      @RequestBody PayeesResponse payeesResponse, @PathVariable(name = "customerId", required = true) String customerId) {
    ApplicationLogger.logInfo("Updating payee response...", this.getClass());
